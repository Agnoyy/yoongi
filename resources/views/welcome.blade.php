...
<body>
  ...
  <div id="topbar" class="d-flex align-items-center fixed-top">
    <div class="container d-flex justify-content-center justify-content-md-between">
      ...
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-phone d-flex align-items-center"><span>+62 85780126770</span></i>
        <i class="bi bi-clock d-flex align-items-center ms-4"><span> Mon-Sat: 11AM - 23PM</span></i>
      </div>

      <div class="languages d-none d-md-flex align-items-center"></div>
    </div>
  </div>
  ...
  <header id="header" class="fixed-top d-flex align-items-cente">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      <h1 class="logo me-auto me-lg-0"><a href="{{ url("index.html") }}">Amora Italy</a></h1>
      <!-- Uncomment below if you prefer to use an image logo -->
      <!-- <a href="{{ url("index.html") }}" class="logo me-auto me-lg-0"><img src="assets/img/logo.png" alt="" class="img-fluid"></a>-->
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="btn-book-a-table" href="{{ route('login') }}">Login</a></li>
          <li><a class="nav-link scrollto" href="{{ route('register') }}">Register</a></li>
        </ul>
        <i class="bi bi-list mobile-nav-toggle"></i>
      </nav><!-- .navbar -->
      <a href="{{ url("#book-a-table") }}" class="book-a-table-btn scrollto d-none d-lg-flex">Book a table</a>
    </div>
  </header><!-- End Header -->
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container position-relative text-center text-lg-start" data-aos="zoom-in" data-aos-delay="100">
      <div class="row">
        <div class="col-lg-8">
          <h1>Welcome To <span>AMORTALY</span></h1>
          <h2>Memberikan Makanan Enak Selama 12 Tahun</h2>

          <div class="btns">
            <a href="{{ url("#menu") }}" class="btn-menu animated fadeInUp scrollto">Menu</a>
            <a href="{{ url("#book-a-table") }}" class="btn-book animated fadeInUp scrollto">Video</a>
          </div>
        </div>
        ...
        <div class="row menu-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-6 menu-item filter-starters">
            ...
            <div class="menu-content">
              <a href="{{ url("#") }}">Lobster Bisque</a><span>$5.95</span>
            </div>
          ...
          <div class="col-lg-6 menu-item filter-specialty">
            ...
            <div class="menu-content">
              <a href="{{ url("#") }}">Bread Barrel</a><span>$6.95</span>
            </div>
            <div class="menu-ingredients">
              Lorem, deren, trataro, filede, nerada
            </div>
          ...
          <div class="col-lg-6 menu-item filter-starters">
            ...
            <div class="menu-content">
              <a href="{{ url("#") }}">Crab Cake</a><span>$7.95</span>
            </div>
            <div class="menu-ingredients">
          ...
          <div class="col-lg-6 menu-item filter-salads">
            ...
            <div class="menu-content">
              <a href="{{ url("#") }}">Caesar Selections</a><span>$8.95</span>
            </div>
            <div class="menu-ingredients">
              Lorem, deren, trataro, filede, nerada
            </div>
          ...
          <div class="col-lg-6 menu-item filter-specialty">
            ...
            <div class="menu-content">
              <a href="{{ url("#") }}">Tuscan Grilled</a><span>$9.95</span>
            </div>
            <div class="menu-ingredients">
          ...
          <div class="col-lg-6 menu-item filter-starters">
            ...
            <div class="menu-content">
              <a href="{{ url("#") }}">Mozzarella Stick</a><span>$4.95</span>
            </div>
            <div class="menu-ingredients">
              Lorem, deren, trataro, filede, nerada
            </div>
          ...
          <div class="col-lg-6 menu-item filter-salads">
            ...
            <div class="menu-content">
              <a href="{{ url("#") }}">Greek Salad</a><span>$9.95</span>
            </div>
            <div class="menu-ingredients">
          ...
          <div class="col-lg-6 menu-item filter-salads">
            ...
            <div class="menu-content">
              <a href="{{ url("#") }}">Spinach Salad</a><span>$9.95</span>
            </div>
            <div class="menu-ingredients">
          ...
          <div class="col-lg-6 menu-item filter-specialty">
            ...
            <div class="menu-content">
              <a href="{{ url("#") }}">Lobster Roll</a><span>$12.95</span>
            </div>
            <div class="menu-ingredients">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-3">
            <ul class="nav nav-tabs flex-column">
              <li class="nav-item">
                <a class="nav-link active show" data-bs-toggle="tab" href="{{ url("#tab-1") }}">Modi sit est</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="{{ url("#tab-2") }}">Unde praesentium sed</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="{{ url("#tab-3") }}">Pariatur explicabo vel</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="{{ url("#tab-4") }}">Nostrum qui quasi</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="{{ url("#tab-5") }}">Iusto ut expedita aut</a>
              </li>
            </ul>
          </div>
            ...
            <div class="tab-content">
              <div class="tab-pane active show" id="tab-1">
                <div class="row">
                  ...
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img src="{{ asset("/frontend/assets/img/specials-1.png") }}" alt="" class="img-fluid">
                  </div>
                </div>
              </div>
              <div class="tab-pane" id="tab-2">
                <div class="row">
                  ...
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img src="{{ asset("/frontend/assets/img/specials-2.png") }}" alt="" class="img-fluid">
                  </div>
                </div>
              </div>
              <div class="tab-pane" id="tab-3">
                <div class="row">
                  ...
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img src="{{ asset("/frontend/assets/img/specials-3.png") }}" alt="" class="img-fluid">
                  </div>
                </div>
              </div>
              <div class="tab-pane" id="tab-4">
                <div class="row">
                  ...
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img src="{{ asset("/frontend/assets/img/specials-4.png") }}" alt="" class="img-fluid">
                  </div>
                </div>
              </div>
              <div class="tab-pane" id="tab-5">
                <div class="row">
                  ...
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img src="{{ asset("/frontend/assets/img/specials-5.png") }}" alt="" class="img-fluid">
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="row g-0">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="{{ url("assets/img/gallery/gallery-1.jpg") }}" class="gallery-lightbox" data-gall="gallery-item">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="{{ url("assets/img/gallery/gallery-2.jpg") }}" class="gallery-lightbox" data-gall="gallery-item">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="{{ url("assets/img/gallery/gallery-3.jpg") }}" class="gallery-lightbox" data-gall="gallery-item">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="{{ url("assets/img/gallery/gallery-4.jpg") }}" class="gallery-lightbox" data-gall="gallery-item">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="{{ url("assets/img/gallery/gallery-5.jpg") }}" class="gallery-lightbox" data-gall="gallery-item">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="{{ url("assets/img/gallery/gallery-6.jpg") }}" class="gallery-lightbox" data-gall="gallery-item">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="{{ url("assets/img/gallery/gallery-7.jpg") }}" class="gallery-lightbox" data-gall="gallery-item">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="{{ url("assets/img/gallery/gallery-8.jpg") }}" class="gallery-lightbox" data-gall="gallery-item">
